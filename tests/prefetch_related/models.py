...
class DirectBio(models.Model):
    author = models.OneToOneField(Author, models.CASCADE, primary_key=True, related_name="direct_bio")
    books = models.ManyToManyField(Book, blank=True)


class YearlyBio(models.Model):
    author = models.ForeignKey(Author, models.CASCADE, primary_key=True, related_name="yearly_bios")
